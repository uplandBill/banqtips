...
function extract_list(eeType) {
  ...
  var listParms={"listId":"empListing", "listTab":"empList", "alphaId":"empAlphas", "buttId":"empListButts"};
  load_ee_list2(eeListObj, resId, listParms);
  //delete lettters
  removeKids(document.getElementById("empAlphas"));
  document.getElementById(resId).removeChild(document.getElementById("empAlphas"));
  load_ee_letters(eeListObj, resId, listParms);
...
function load_ee_list2(eeListObj, destId, objParms) {
   ...
   removeElm(destId, objParms["listId"]);
...
//   alert("Load " + targ.getAttribute("eeType"));
   extract_list(targ.getAttribute("eeType"));
}
...
function add_audit_butts(unitId) {
   ...
   butt1.setAttribute("value","Full View");
   butt1.setAttribute("type","button");
   addEvent(butt1, 'click', function() {window.open("./auditWeek.php5?unitId="+unitId);});
   theform.appendChild(butt1);
}
