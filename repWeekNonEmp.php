...
$gratSQL = $gratSQL . " from events e, funcGrats g, gratTypes gt where e.unitId='$unitId' and e.wkendDate ='$wkendDate' and g.unitId = e.unitId and g.eventNum = e.eventNum";
...
$detsSQL = $detsSQL . " from funcEmps e, employees n, events v, depts d where v.unitId='$unitId' and v.wkendDate = '$wkendDate' and e.unitId = v.unitId and e.eventNum = v.eventNum";
$detsSQL = $detsSQL . " and n.unitId = v.unitId and n.emplid = e.emplid and d.unitId = v.unitId and d.deptId = n.deptId and d.effdt = (select max(effdt) from depts d2 where d2.deptId = d.deptId)";
...
$detsSQL = $detsSQL . " and n.locid <> '$unitId'";
$detsSQL = $detsSQL . " group by n.emplid, n.name, d.dud, n.jobcode";
$detsSQL = $detsSQL . " order by n.locid, n.emplid";
...
while ($detsRecs = $detsResult->fetch_row()) {
   ...
   if ($lineCnt == 0) {
      ...
      echo "<tr><td class='headLeft'><h4>Unit: $locid</h4></td><td></td><td class='headRight'><h4></h4></td></tr>";
...
//
   for ($i=1; $i<=$gratCnt; $i++) {
      $gratType = $grats[$i];
      $gratSums = "Select sum(eg.gratAmt) from funcEmpGrats eg, events e";
      $gratSums = $gratSums . " where e.unitId = '$unitId' and e.wkendDate = '$wkendDate' and eg.unitId = e.unitId and eg.eventNum = e.eventNum and eg.emplid = '$emplid' and eg.gratType = '$gratType'";
