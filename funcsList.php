<?php
  ...
  $buttLab   = $_GET['buttLab'];
  $buttAct   = $_GET['buttAct'];
     ...
     echo "Please Logon";
  	...
  	if ($unitId == "" || $wkendDate=="") {
       ...
       if ($rows > 0){
          ...
          echo "<table border='1'>";
          echo "<tr><th>Event Num</th><th>Func Num</th><th>Func Date</th><th>Grats</th><th>Employees</th><th>Emp Cnts</th><th>Emp Grats</th></tr>";
          $cnt = 0;
          ...
          echo "</table>";
          echo "</div>";
          echo '<input value="Delete Week" type="button" onclick=' . "'javascript:doWeek(" .'"'. $buttAct .'","'. $unitId .'","'. $wkendDate .'"'. ");" . "'/>";
       } else {       
